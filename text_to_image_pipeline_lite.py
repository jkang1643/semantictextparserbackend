...
from text_segmenter_lite import TextSegmenterLite
from prompt_generator import PromptGenerator
from image_generator import ImageGenerator

class TextToImagePipelineLite:
    def __init__(self, 
                 segmentation_method: str = "rule_based",
                 image_service: str = "dalle",
                 max_tokens_per_chunk: int = 512,
                 similarity_threshold: float = 0.6):
        """
        Initialize the lightweight text-to-image pipeline.
        ...
        self.text_segmenter = TextSegmenterLite(
    ...
    def process_text(self, text: str, style: str = "realistic", 
        ...
        """
        print("🚀 Starting lightweight text-to-image pipeline...")
        
        # Step 1: Extract entities BEFORE preprocessing (to preserve capitalization)
        print("👥 Extracting characters...")
        self.characters = self.text_processor.extract_entities(text)
